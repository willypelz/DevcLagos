	   ...
	   <div class="row-fluid">
	    ...
	    <div class="col-lg-8 white">	
		 ...
		 <form method="post" class="list-search revealOnScroll" data-animation="fadeInDown" data-timeout="200">
		  ...
		  <input type="text" class="form-control" name="searchterm" placeholder="<?php echo $lang['service']; ?> <?php echo $lang['category']; ?> <?php echo $lang['title']; ?>, <?php echo $lang['keywords']; ?> <?php echo $lang['or']; ?> <?php echo $lang['company']; ?> <?php echo $lang['name']; ?>" value=""/>
		  ...
		  <?php		
            ...
            $q1 = DB::getInstance()->get("service", "*", ["catid" => $catid]);
		    $total = $q1->count();
		  
          $query = DB::getInstance()->get("service", "*", ["ORDER" => "date_added DESC", "LIMIT" => [$startpoint, $limit],
															"AND" => [
															    "catid" => $catid
															]]);
		...
		//print
		echo Pagination($total,$limit,$page,'searchcatservice.php?searchterm='.$searchterm.'&');
        ?>
