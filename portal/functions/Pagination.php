...
function Pagination($total, $per_page = 10,$page = 1, $url = '?'){  
    	...
    	if($lastpage > 1)
    	{
    		$pagination .= "<div class='page text-center'><ul class='pagination'>";
                    $pagination .= "<li class='details'>Page $page of $lastpage</li>";
					
			if ($page > 1)
				$pagination.= "<li><a href='{$url}page=1'> <i class='fa  fa-angle-double-left'></i> </a></li>
    		...
    		if ($page < $counter - 1){ 
    			$pagination.= "<li><a href='{$url}page=$next'><i class='fa fa-angle-right'></i></a></li>";
                $pagination.= "<li><a href='{$url}page=$lastpage'><i class='fa fa-angle-double-right'></i></a></li>";
    		}else{
